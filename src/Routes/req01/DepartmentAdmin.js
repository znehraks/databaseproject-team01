  ...
  return (
    <Container maxwidth="md" className={classes.root}>
      <Grid container spacing={2}>
        <Grid item md={5}>
          {departments && <DepartmentTable departments={departments} selectedRow={selectedRow} handleRowClick={handleRowClick} />}
        </Grid>
        <Grid item md={7}>
          {
            departmentEmployee && <DepartmentEmployeeTable departmentEmployee={departmentEmployee} selectedRow={selectedRow} />
          }
        </Grid>
      </Grid>
    </Container>
